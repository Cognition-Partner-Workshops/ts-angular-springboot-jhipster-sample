...
/**
 * REST controller for managing {@link io.github.jhipster.sample.domain.Invoice}.
 */
@RestController
...
public class InvoiceResource {
    ...
    public ResponseEntity<Invoice> partialUpdateInvoice(
        ...
        Optional<Invoice> result = invoiceRepository
            ...
            .map(existingInvoice -> {
                updateIfPresent(existingInvoice::setNumber, invoice.getNumber());
                updateIfPresent(existingInvoice::setDate, invoice.getDate());
                updateIfPresent(existingInvoice::setDueDate, invoice.getDueDate());
                updateIfPresent(existingInvoice::setAmount, invoice.getAmount());
                updateIfPresent(existingInvoice::setStatus, invoice.getStatus());
