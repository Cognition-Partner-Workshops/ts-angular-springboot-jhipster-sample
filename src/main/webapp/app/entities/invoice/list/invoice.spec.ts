...
describe('Invoice Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.invoices()[0]).toEqual(expect.objectContaining({ id: 28743 }));
  });

  describe('trackId', () => {
    it('should forward to invoiceService', () => {
      const entity = { id: 28743 };
      vitest.spyOn(service, 'getInvoiceIdentifier');
  ...
  describe('delete', () => {
    ...
    it('on dismiss should call load', inject([], () => {
      ...
      // WHEN
      comp.delete(sampleWithRequiredData);
      deleteModalMock.closed.complete();
