...
import static io.github.jhipster.sample.domain.InvoiceAsserts.*;
...
import io.github.jhipster.sample.domain.InvoiceStatus;
...
class InvoiceResourceIT {
    ...
    private static final String DEFAULT_NUMBER = "INV-0001";
    private static final String UPDATED_NUMBER = "INV-0002";
    ...
    void putExistingInvoice() throws Exception {
        ...
        updatedInvoice.number(UPDATED_NUMBER).date(UPDATED_DATE).dueDate(UPDATED_DUE_DATE).amount(UPDATED_AMOUNT).status(UPDATED_STATUS);
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.amount(UPDATED_AMOUNT).status(UPDATED_STATUS);
